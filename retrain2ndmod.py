...
TRAINING_IMAGES_DIR = os.getcwd() + '/training_images111'

TEST_IMAGES_DIR = os.getcwd() + "/test_images111/"

# where to save the trained graph
OUTPUT_GRAPH = os.getcwd() + '/' + 'retrained_graph111.pb'
...
OUTPUT_LABELS = os.getcwd() + '/' + 'retrained_labels111.txt'

# where to save summary logs for TensorBoard
TENSORBOARD_DIR = os.getcwd() + '/' + 'tensorboard_logs111'
...
MODEL_DIR = os.getcwd() + "/" + "model111"

# Path to cache bottleneck layer values as files
BOTTLENECK_DIR = os.getcwd() + '/' + 'bottleneck_data111'
